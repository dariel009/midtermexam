                     ...
                     <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                        <div class="full">
                           <div class="center-desk">
                              <div class="logo">
                                 <a href="index.html"><img src="http://localhost/darielshop/wp-content/uploads/2021/06/logo.png" alt="#" /></a>
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-8 offset-md-2 ">
                  <div class="about_box ">
                     <figure><img src="http://localhost/darielshop/wp-content/uploads/2021/06/about_img.png" alt="#"/></figure>
               ...
               <div class="col-sm-12">
                  <div class="black_bg">
                     <div class="row">
                        ...
                        <div class="col-md-5">
                           <div class="mane_img">
                              <figure><img src="http://localhost/darielshop/wp-content/uploads/2021/06/mane_img.jpg" alt="#"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row d_flex">
               <div class="col-md-6">
                  <div class="two_box_img">
                     <figure><img src="http://localhost/darielshop/wp-content/uploads/2021/06/leptop.jpg" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="two_box_img">
                              ...
                              <div class="carousel-caption ">
                                 <div class="row">
                                    <div  class="col-md-12">
                                       <div class="test_box">
                                          <h3>Michl ro</h3>
                                          <p><i class="padd_rightt0"><img src="http://localhost/darielshop/wp-content/uploads/2021/06/te1.png" alt="#"/></i>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some <i class="padd_leftt0"><img src="http://localhost/darielshop/wp-content/uploads/2021/06/te2.png" alt="#"/></i> <br>form, by injected humour, or randomised words which don't look even slightly believable</p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="carousel-caption">
                                 <div class="row">
                                    <div  class="col-md-12">
                                       <div class="test_box">
                                          <h3>Michl ro</h3>
                                          <p><i class="padd_rightt0"><img src="http://localhost/darielshop/wp-content/uploads/2021/06/te2.png" alt="#"/></i>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some <i class="padd_leftt0"><img src="http://localhost/darielshop/wp-content/uploads/2021/06/te2.png" alt="#"/></i> <br>form, by injected humour, or randomised words which don't look even slightly believable</p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
